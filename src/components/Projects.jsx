...
import project_22 from "../public/proyekt_22.png";
import project_23 from "../public/proyekt_23.png";
...
const projectsData = [
  ...
  {
    title: { az: "Park Cinema klon vebsayt", en: "Park Cinema clone website", ru: "Парк кинотеатр клон вебсайт" },
    description: { 
      az: "🎬 Parkcinema.az HTML5 | CSS3 • React.js • Tailwindcss • Axios • Node.js",
      en: "🎬 Parkcinema.az HTML5 | CSS3 • React.js • Tailwindcss • Axios • Node.js",
      ru: "🎬 Parkcinema.az HTML5 | CSS3 • React.js • Tailwindcss • Axios • Node.js"
    },
    image: `${project_22}`,
    tags: ["HTML5", "CSS3" , "Vanilla JS", "Swiper JS"],
    github: "https://github.com/CaspianDiv/ParkCinema-Cloune_React.js-",
    demo: "https://park-cinema-cloune-react-js.vercel.app/movies",
  },
  {
    title: { az: "Thomann Final Proyekt Frontend", en: "Thomann Final Project Frontend", ru: "Финальный проект Thomann: Фронтенд" },
    description: { 
      az: "🎸 Thomann Final Proyekt Frontend Klon vebsayt | HTML5 • CSS3 • Tailwindcss • React.js • Axios • Node.js ",
      en: "🎸 Thomann Final Proyekt Frontend Klon vebsayt | HTML5 • CSS3 • Tailwindcss • React.js • Axios • Node.js",
      ru: "🎸 Финальный проект Thomann: клонирование фронтенда веб-сайта | HTML5 • CSS3 • Tailwindcss • React.js • Axios • Node.js"
    },
    image: `${project_23}`,
    tags: ["HTML5", "CSS3" , "Vanilla JS", "Swiper JS"],
    github: "https://github.com/CaspianDiv/turbo.az-Cloune-Website-",
