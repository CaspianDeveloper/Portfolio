      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3 mt-5">
               ...
               <img src={`${logo}`} className="rounded-full h-10" alt="image" /> <span className="text-[1rem] lg:text-xl xl:text-xl">Caspian Dev</span> <FaCode size={20} className="text-[#2463eb] mt-1" />
          </div>
          </motion.a>
